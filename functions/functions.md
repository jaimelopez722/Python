...
---
We can define a function in Python, using the [def keyword](https://www.geeksforgeeks.org/python/python-def-keyword/). A function might take input in the form of parameters.
...
---
The [return](https://www.geeksforgeeks.org/python/python-return-statement/) statement ends a function and sends a value back to the caller. It can return any data type, multiple values (packed into a tuple), or None if no value is given.
### Syntac:
```
return [expression]
```
